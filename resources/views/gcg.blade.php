...
<div class="row">
    <div class="col-sm-8">  
        <div class="card mb-5">
            <div class="card-body">
    <h1>Good Corporate Governance</h1><h1> PT. Jamkrida NTB Syariah</h1>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>Laporan GCG</td>
                <td>2023</td>
                <td><a target="_BLANK" href="https://drive.google.com/file/d/1zK4P9rLCS_gSf92yXvf_bZfjvK2dWlM3/view?usp=drive_link" class="btn btn-success"><b style="color: #ffffff">Download</b></a></td>
            </tr>
        </tbody> 
    </table>  
    </p>
