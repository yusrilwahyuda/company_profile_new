jQuery(document).ready(function ($) {
	...
	if ($.isFunction($.fn.perfectScrollbar)) {
		$('.dropdowns, .twiter-feed, .invition, .followers, .chatting-area, .peoples, #people-list, #people-list2, .chat-list > ul, .message-list, .chat-users, .left-menu').perfectScrollbar();
	}
	...
	(
		function ($) {
			...
			function listFilter(searchDir2, list) {
				var form = $("<form>").attr({
						"class": "filterform",
						"action": "#"
					}),
